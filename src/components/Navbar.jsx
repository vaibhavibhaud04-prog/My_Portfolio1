                ...
                <div className="hidden lg:flex items-center space-x-6">
                    {navItems.map((item)=>(
                        <a
                            ...
                            className="relative"
                        >
                           <motion.span className={`font-medium transition-colors duration-300 ${colors.textPrimary}`}>
                            {item.name}
                            </motion.span>
                            {activeSection === item.name.toLocaleLowerCase() && (
                                <motion.div
                                layoutId="navbar-indicator"
                                className={`absolute -buttom-1 left-0 
                                right-0 h-0.5 bg-linear-to-r rounded-full ${colors.indicator}`}>
